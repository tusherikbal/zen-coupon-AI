 ...
 * Text Domain: zencoupon-ai-assistance
 ...
 * Main Plugin Class
 */
final class ZenCoupon_AI_Assistant {

    public const VERSION        = '1.0.1';
    public const PLUGIN_SLUG    = 'zencoupon-ai-assistant';
    public const OPTION_KEY     = 'zencoupon_ai_assistant_settings';
    public const TEXT_DOMAIN    = 'zencoupon-ai-assistance';
    public const REST_NAMESPACE = 'zencoupon/v1';
    public const REST_ROUTE     = 'mcp';

    private static ?ZenCoupon_AI_Assistant $instance = null;

    /**
     * Singleton Instance
     */
    public static function instance(): ZenCoupon_AI_Assistant {
    ...
    private function define_constants(): void {
        ...
        if ( ! defined( 'ZENCUPON_PLUGIN_DIR' ) ) {
        ...
        if ( ! defined( 'ZENCUPON_PLUGIN_URL' ) ) {
    ...
    private function includes(): void {
        ...
        require_once ZENCUPON_PLUGIN_DIR . 'includes/class-zencoupon-actions.php';
        require_once ZENCUPON_PLUGIN_DIR . 'includes/class-zencoupon-mcp.php';
        require_once ZENCUPON_PLUGIN_DIR . 'includes/class-zencoupon-ai-bridge.php';
        require_once ZENCUPON_PLUGIN_DIR . 'includes/class-zencoupon-admin.php';
    }
 ...
 */
function zencoupon_ai_assistant(): ZenCoupon_AI_Assistant {

    return ZenCoupon_AI_Assistant::instance();
}
